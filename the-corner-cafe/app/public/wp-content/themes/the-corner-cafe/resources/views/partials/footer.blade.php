...
<footer class="footer">
  <div class="footer-links">
    ...
    <div class="footer-menu">
      {!! wp_nav_menu(['menu' => 'footer_menu', 'menu_class' => 'footer-nav']) !!}
    </div>
  </div>
  <div class="footer-locations">
    ...
    <div class="information information-riverside">
      ...
      <div class="street"><a href="{{ $riverside_information['address_link'] }}">{{ $riverside_information['street_address'] }}</a></div>
      <div class="phone"><a href="tel:{{ $riverside_information['phone_number'] }}">{{ $riverside_information['phone_number'] }}</a></div>
    </div>
    <div class="information information-liberty">
      <div class="city">LIBERTY</div>
      <div class="street"><a href="{{ $liberty_information['address_link'] }}">{{ $liberty_information['street_address'] }}</a></div>
      <div class="phone"><a href="tel:{{ $liberty_information['phone_number'] }}">{{ $liberty_information['phone_number'] }}</a></div>
    </div>
    <div class="information information-independence">
      <div class="city">INDEPENDENCE</div>
      <div class="street"><a href="{{ $independence_information['address_link'] }}">{{ $independence_information['street_address'] }}</a></div>
      <div class="phone"><a href="tel:{{ $independence_information['phone_number'] }}">{{ $independence_information['phone_number'] }}</a></div>
    </div>
  </div>
...
<div class="sub-footer">
  ...
  <a href="https://makedigitalgroup.com/" target='_blank' @if (basename($_SERVER['REQUEST_URI']) != "") : rel='nofollow' @endif>
