...
<div class="section-partnerships">
    ...
    <div class="section-partnerships__description"><p><?php echo e($section_fields['partnerships_description']); ?></p></div>
    <div class="partners-container">
        ...
        <div class="partner-card">
            ...
            <div class="partner-description"><p><?php echo $card['partner_description']; ?></p></div>
        </div>
