    ...
    <div class="locations-container">
        ...
        <div class="location">
            ...
            <div class="social-icons">
                ...
                <a target="_blank" href="<?php echo e($riverside_info['instagram_link']); ?>"><div class="instagram-icon"></div></a>
            </div>
        ...
        <div class="location">
            ...
            <div class="social-icons">
                ...
                <a target="_blank" href="<?php echo e($liberty_info['instagram_link']); ?>"><div class="instagram-icon"></div></a>
            </div>
        ...
        <div class="location">
            ...
            <div class="social-icons">
                ...
                <a target="_blank" href="<?php echo e($independence_info['instagram_link']); ?>"><div class="instagram-icon"></div></a>
            </div>
